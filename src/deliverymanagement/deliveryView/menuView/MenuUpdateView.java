...
public class MenuUpdateView extends JPanel {
    JTable table;
    ...
    public MenuUpdateView(ArrayList<String> storeList) {
        setLayout(new BorderLayout());
        storeCombo = new JComboBox<>(storeList.toArray(new String[0]));
        btnUpdate = new JButton("메뉴수정");
    ...
    public void setTextField(int rowIndex) {
        ...
        textFields[0].setText(id.toString());
        storeCombo.setSelectedItem(model.getValueAt(rowIndex, 1));
        textFields[1].setText(String.valueOf(model.getValueAt(rowIndex, 2)));
        textFields[2].setText(String.valueOf(model.getValueAt(rowIndex, 3)));
        textFields[3].setText(String.valueOf(model.getValueAt(rowIndex, 4)));
    }
    ...
    public MenuVO neededMenuUpdate() {
        MenuVO vo = new MenuVO();
    ...
    public void initMenuUpdateData() {
