...
public class MemberInsertVIew extends JPanel {
    JTable table;
    ...
    public MemberVO neededInsertMemberData() {
     MemberVO mVO = new MemberVO();
     mVO.setMemberId(textFields[0].getText());
     mVO.setMemberPassword(textFields[1].getText());
     mVO.setMemberName(textFields[2].getText());
     mVO.setMemberPhone(textFields[3].getText());
     mVO.setMemberAddress(textFields[4].getText());
     mVO.setMemberRole((String) roleCombo.getSelectedItem());

     return mVO;
    }
    public void initInsertMemberData() {
